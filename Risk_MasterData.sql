...
('e969a6eb-2819-445f-a3f5-1aad40ad75b4','What is the estimated end contract annual cost estimate?',NULL,NULL,1)
,('7867249a-657a-489a-9203-1754ed8885cc','How many separate contracts are estimated for this project?',NULL,NULL,2)
,('3c998138-1cd7-4ae4-b86f-5b18c404b2c8','Anticipated procurement approach',NULL,NULL,3)
...
,('f69586ae-dd89-44dc-8288-e4efe98984c2','How many people (part-time or full-time on the project, including BC Gov employees and individual contractors) are required to complete this project at its peak activity?',NULL,NULL,6)
,('1cfc4878-0257-4da8-8838-1729be5b8ee1','From project defintion to project close-out, what is the expected duration of the project?',NULL,NULL,7)
,('1f71e8bc-5b88-40c3-ab99-553368ebf685','How many Ministries or BPS Entities are directly involved in the project?',NULL,NULL,8)
,('a19f05bd-8172-4994-b991-fc717b0e46f2','Are there any socio-economic considerations that must be taken into account?',NULL,NULL,9)
,('2d4fd180-ef23-4134-8014-be2ec8ed1ec5','Is their high public interest in the project?',NULL,NULL,10)
;
INSERT INTO public.risk_questions (id,question,category,"riskLevel","questionNo") VALUES 
('e11046b5-dfcf-4343-aff8-651670cc783f','Do considerations relating to Aboriginal people (including land claims and Aboriginal consultation obligations) influence the manner in which the project is conducted?',NULL,NULL,11)
,('a08e56db-b334-4270-affc-a8f6e2c0fd0a','What level of priority is the project to the owning Ministry?',NULL,NULL,12)
,('c81159f4-42bb-48b1-8338-592df3b43eff','What is the supplier availability and willingness?',NULL,NULL,13)
,('ec300240-d516-40d4-b9b3-8a23d8f4e951','Will the resulting contract offer government opportunity for innovation or modernization',NULL,NULL,14)
,('cf3e8c59-eefb-48cb-b427-4f1abdae2ed1','Does the organization anticipate a shortage of available personnel with appropriate skills during a significant period of the project?',NULL,NULL,15)
...
,('dfd744a6-c142-42e9-9dc9-377407f8bceb','Has the assigned project lead worked on a project of this size and complexity before?',NULL,NULL,17)
,('94ec86da-f955-4e3d-b0ba-932b3044abdb','Are the services public facing?',NULL,NULL,18)
,('82d17998-d5a7-4a15-830d-8a39d2e68a01','Are there expected challenges to ensure that this project complies with relevant Treasury Board policy requirements, such as those regarding security, GBA+, privacy, and management of government information?',NULL,NULL,19)
,('4170bc6a-3146-486a-89fe-d147718678cc','Will the project result in a contract that is one of a larger bundle of contracts supporting a strategic initiative? (ie requires an integrator)',NULL,NULL,20)
;


INSERT INTO public.risk_answers (id,answer,score,"questionId") VALUES 
('78500ca2-c957-4999-96a2-360e5ec78f45','>50k',1,'e969a6eb-2819-445f-a3f5-1aad40ad75b4')
,('41a02614-dae7-4c48-b1d6-b4c241e2d62f','>250k',2,'e969a6eb-2819-445f-a3f5-1aad40ad75b4')
,('f24e1de4-824b-4eec-aac0-5dade4d3c2b9','500k-1 million',3,'e969a6eb-2819-445f-a3f5-1aad40ad75b4')
,('23a93640-3a41-44b9-9f9a-71ee45f7bffb','$1-10 million',4,'e969a6eb-2819-445f-a3f5-1aad40ad75b4')
,('af07c63d-4c96-40ad-83e5-a9e06ab64fb6','over $10 million',5,'e969a6eb-2819-445f-a3f5-1aad40ad75b4')
,('2cc39349-373b-4aa6-9046-9bd23fa24610','One contract',1,'7867249a-657a-489a-9203-1754ed8885cc')
,('e6379225-7cd4-48e9-9d3b-7fee086dd006','Two contracts',2,'7867249a-657a-489a-9203-1754ed8885cc')
,('88ea130f-75dd-4dc1-a12d-4f0d6c4e81e5','Three contracts',3,'7867249a-657a-489a-9203-1754ed8885cc')
,('07b9cbd0-719b-4f07-8713-ff220267239c','Four contracts',4,'7867249a-657a-489a-9203-1754ed8885cc')
,('cf38beb1-58af-43c3-be69-0706a0806df8','Five or more contracts',5,'7867249a-657a-489a-9203-1754ed8885cc')
;
INSERT INTO public.risk_answers (id,answer,score,"questionId") VALUES 
...
,('a76fe051-d46b-4ca5-9029-a2114b3fc3b2','No, the project is not susceptible',1,'183b80f2-4688-41fd-ae1c-5a6e7f777c3f')
,('a5fdcb8e-3464-4eff-961b-329f0b1858a9',' Yes, the project is moderately susceptible; time delays will have minor effects on the schedule',3,'183b80f2-4688-41fd-ae1c-5a6e7f777c3f')
,('ce0d7769-846c-4f1d-8f56-a3c1099af29f','Yes, the project is highly susceptible; time delays will have major effects on the schedule',5,'183b80f2-4688-41fd-ae1c-5a6e7f777c3f')
